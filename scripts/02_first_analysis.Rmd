...
SeasonList = genSeasonList(washington_DF, mrange = c(11,5), years = season_years)# The ‘years‘ argument specifies the year, in which the dormancy season of interest ends.
...
predicted_bloom_Jdays_washington = chillR:::predictBloomDays(par = Fit_res$par, SeasonList = Fit_res$SeasonList, 
...
predicted_bloom_Jdays_kyoto = chillR:::predictBloomDays(par = Fit_res_kyoto$par, SeasonList = Fit_res_kyoto$SeasonList, 
        modelfn = Fit_res_kyoto$modelfn)
```
...
predicted_bloom_Jdays_basel = chillR:::predictBloomDays(par = Fit_res_basel$par, SeasonList = Fit_res_basel$SeasonList, 
        modelfn = Fit_res_basel$modelfn)
# same as
predicted_bloom_Jdays_basel = Fit_res_basel$pbloomJDays
